...
first take note of the fields that you'd have used from the different tables to build the viusal. Then create a data table visual/chart of the fields from the 
different tables to see if the information is rightly organised like you want. The information in the table visual/chart gives you preview of how the table going to be used by your visual */
